            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm">
                        <img loading="lazy"
                            src="<?php echo get_template_directory_uri(); ?>/src/assets/img/ServiciosTI.jpg"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm">
                        <img loading="lazy"
                            src="<?php echo get_template_directory_uri(); ?>/src/assets/img/Infraestructura.jpg"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm">
                        <img loading="lazy"
                            src="<?php echo get_template_directory_uri(); ?>/src/assets/img/Planeacion.jpg"
